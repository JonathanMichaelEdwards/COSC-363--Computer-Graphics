...
// Compile and Run:
// - Linux:   g++ -no-pie Teapot.cpp -o Teapot -lGL -lGLU -lglut && ./Teapot
// - Windows: g++ Teapot.cpp -o Teapot -lOpenGL32 -lGLU32 -lfreeGLUT && Teapot
...
float angleX = 1.0,  angleY = -10;	//Rotation angles about x, y axes
...
void initialize()
{
    ...
    loadMeshFile("demo.off");			//Specify mesh file name here
