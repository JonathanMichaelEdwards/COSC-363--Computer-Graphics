...
void loadTexture()				
{
	...
	glTexEnvi(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE);  // darker texture
	// glTexEnvi(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_REPLACE); // light
}
...
void wagon()
{
	...
	glBegin(GL_QUADS);
	  ...
	  glTexCoord2f(0., 0.);         glVertex3f(-35.0, 5.0, -6.0);
	  glTexCoord2f(0., 0.);         glVertex3f(-35.0, 5.0, 6.0);
	  glTexCoord2f(0., 0.);         glVertex3f(-35.0, 17.0, 6.0);
	  glTexCoord2f(0., 0.);         glVertex3f(-35.0, 17.0, -6.0);
