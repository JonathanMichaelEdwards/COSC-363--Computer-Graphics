...
/** -----------------------------------------------------------------------------
 	@param lightPos  -  light's position.
	@param viewVec   -  view vector.
	@param hit       -  point of intersection where the colour value needs to 
						be computed. 

	@return colorSum - color sum of all combinations of light.
					   i.e (Ambiant + Diffuse + Specular)
// ----------------------------------------------------------------------------*/
